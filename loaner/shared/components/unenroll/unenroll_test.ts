...
import {UnenrollDialogComponent} from './index';
import {MaterialModule} from './material_module';

/** Mock material DialogRef. */
class MatDialogRefMock {}

describe('UnenrollDialogComponent', () => {
  let component: UnenrollDialogComponent;
  let fixture: ComponentFixture<UnenrollDialogComponent>;
  let compiled: HTMLElement;

  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [UnenrollDialogComponent],
      imports: [
    ...
    fixture = TestBed.createComponent(UnenrollDialogComponent);
  ...
  it('renders the correct success title and message', () => {
    ...
    expect(compiled.querySelector('.mat-dialog-content')!.textContent)
        .toContain('Device 123 has been successfully unenrolled');
  });
