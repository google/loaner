...
import {ResumeLoanDialog} from './index';
import {MaterialModule} from './material_module';

/** Mock material DialogRef. */
class MatDialogRefMock {}

describe('ResumeLoanDialog', () => {
  let component: ResumeLoanDialog;
  let fixture: ComponentFixture<ResumeLoanDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ResumeLoanDialog);
  ...
  it('should show the success message', () => {
    ...
    expect(compiled.querySelector('.mat-dialog-content')!.textContent)
        .toContain('Your loan has successfully been resumed.');
  });
