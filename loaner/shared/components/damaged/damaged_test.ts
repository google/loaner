...
describe('DamagedDialogComponent', () => {
  let component: DamagedDialogComponent;
  let fixture: ComponentFixture<DamagedDialogComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DamagedDialogComponent);
