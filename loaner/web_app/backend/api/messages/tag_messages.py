...
class Tag(messages.Message):
  ...
  Attributes:
    ...
    visible: bool, Whether the tag is visible in the frontend, defaults to True.
    color: str, The color of the tag, one of the material design color palette.
    protect: bool, Whether the tag is protected from user manipulation.
    description: str, The description for the tag.
  """
  name = messages.StringField(1)
  visible = messages.BooleanField(2, default=True)
