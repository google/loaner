...
"""Tests for backend.actions.send_return_thanks."""
...
class SendReturnThanksTest(loanertest.ActionTestCase):
  """Test the SendThanks Action class."""

  def setUp(self):
    self.testing_action = 'send_return_thanks'
    super(SendReturnThanksTest, self).setUp()
